...
class MainController extends Controller
{
    ...
    public function buy_product(Product $product)
    {
        ...
        return view('front.buy_product', compact('product','checkoutId','integrity'));
    }
    ...
    public function buy_product_thanks($id)
    {
        ...
        $resourcePath = request()->resourcePath;
            ...
            $valid = ['000.000.000','000.000.100','000.100.105','000.100.106','000.100.110','000.100.111','000.100.112','100.390.106','800.900.300'];
